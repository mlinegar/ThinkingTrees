...
MANIFEST_SCHEMA_VERSION = "treepo_cdx.run_manifest.v1"
...
class ArtifactLineage:
    ...
    def __post_init__(self) -> None:
        required = ("chunker", "g", "f", "oracle_online", "oracle_eval", "query_policy")
...
class ManifestRow:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(self, "source_unit_id", str(self.source_unit_id or self.top_level_unit_id))
