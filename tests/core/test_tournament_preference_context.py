"""Tests for tournament preference request context plumbing."""
...
@pytest.mark.anyio
async def test_tournament_strategy_enriched_preference_includes_judge_context():
    from src.core.strategy import CallableStrategy, TournamentConfig, TournamentStrategy
    from src.preference_collection.types import PreferenceResponse
    ...
    strategy = TournamentStrategy(
        ...
        preference_collector=collector,
    )
