...
from src.preference_collection.types import PreferenceRequest


def test_preference_store_human_helpers_export_supervision_and_binary_projection() -> None:
    ...
    assert store.submit_human_pairwise_preference(
        "pair_req",
        preferred="A",
    ...
    assert store.submit_human_scalar_preference(
        "scalar_req",
        score=0.75,
    ...
    preferences = store.to_preference_dataset()
