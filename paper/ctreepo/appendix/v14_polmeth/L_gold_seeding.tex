...
the saved control. The treatment arm's training and evaluation remain
scoped follow-up work; the control arm and the artifact paths above
fix the frame its numbers will land in.
...
training first. The transfer evaluation at leaves $1$, $8$, and $16$
remains scoped follow-up work; the artifact inventory above fixes the
frame its numbers will land in.
