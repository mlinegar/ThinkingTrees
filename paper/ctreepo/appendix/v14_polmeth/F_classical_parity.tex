...
Appendix~\ref{sec:hll-parity} summarizes the HyperLogLog parity
...
This is the pattern Appendix~\ref{sec:hll-parity} verifies on the
...
The default grid (used for Figure~\ref{fig:classical-parity-hll-app} and
...
This subsection elaborates the headline result Appendix~\ref{sec:hll-parity}
...
{\small
\input{assets/hll/tables/classical_parity_hll_longtable.tex}
}
...
Figure~\ref{fig:classical-parity-hll-app} shows the relative MAE of each
...
The headline scaling divergence (Appendix~\ref{sec:hll-parity}) deserves
