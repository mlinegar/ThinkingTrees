...
This appendix gives a constructive counterexample showing that Condition C2 (Idempotence) cannot be derived from Conditions C1 (Sufficiency) and C3 (Merge Consistency).
