...
The proof is induction over the tree, with C2 covering the case where
a state is summarized again before it merges. The appendix records the
corresponding machine-checked theorem names.
