...
A robustness-to-adversarial-sampling analysis --- a constrained-design variance bound that shows why $\pi_{\min}$ is the primary robustness lever and why certificates should be reported over a stress-test grid of $(\pi_{\min}, w_{\max})$ values --- is in Appendix~\ref{app:proofs} (Appendix~\ref{app:audit-robustness}).
