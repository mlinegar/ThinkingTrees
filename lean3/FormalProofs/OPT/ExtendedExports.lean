...
import FormalProofs.OPT.LocalLawObjectives
...
/-!
# Extended Exports: The Remaining OPT Export Surface

This file holds every declaration of the former monolithic
`FormalProofs/OPT/MainTheorems.lean` that is *not* cited by the paper's Lean
crosswalk (`paper/ctreepo/appendix/v13_triangle/E_proof_artifacts.tex`),
moved verbatim. The paper-facing surface lives in
`FormalProofs/OPT/PaperTheorems.lean`; `FormalProofs/OPT/MainTheorems.lean` is
a compatibility shim importing both, so all fully-qualified names are
unchanged. This file keeps the broad OPT import surface of the original.
-/
