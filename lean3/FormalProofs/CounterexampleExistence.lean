...
Counterexample (Section 10) and Existence Results (Section 9):
- g_bad: a summarizer that violates L3
- stability_counterexample theorem
- canonical_rep_exists (Proposition 9.1)
- compact_encoding_exists (Proposition 9.2)
-/
