...
Usage:
    from src.ops_engine.training_framework.preference_types import (
        get_deriver,
        JudgeDeriver,
        GenRMDeriver,
        OracleDeriver,
...
class JudgeDeriver:
    ...
    def _ensure_judge(self):
        ...
        if self.judge is None:
            from src.ops_engine.training_framework.preference import PairwiseJudge
...
class GenRMDeriver:
    ...
    def derive(
        ...
        **kwargs,
        ...
        from src.ops_engine.training_framework.genrm_preference import is_genrm_error
