...
from src.core.engines import EngineSurface, EngineType, resolve_engine_base_url
from src.core.inference_engine import build_inference_engine
from src.core.ops_checks import EvidenceStatus
from src.core.scoring import BoundedScale, ScoringOracle, SimilarityScorer
...
from src.tree.state_tree_runner import FixedBinaryStateTreeRunResult, run_fixed_binary_state_tree
from src.tree.state_tree_verifiers import LawVerifier, MarkovExactVerifier, TextAuditorAdapterVerifier
...
class TreePOLocalLawConfig:
    ...
    def to_audit_config(self) -> Any:
        from src.tree.auditor import AuditConfig, SamplingStrategy
...
def _resolve_engine_type(model_spec: TreePOModelSpec) -> EngineType:
    ...
    if model_spec.base_url:
        ...
        try:
            from src.core.engines import EngineRegistry
