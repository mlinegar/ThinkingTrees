...
from src.training.config_sections import RunConfig, TestConfig, TrainConfig, ValidationConfig, config_to_dict
...
class LearnedStateSummaryAdapter(TreePOContractAdapter):
    ...
    def fit(self, context: TreePOContractFitContext) -> TreePOContractFitResult:
        from src.training.config_sections import OptimizerConfig
...
class LabeledTreeDistillationAdapter(TreePOContractAdapter):
    ...
    def fit(self, context: TreePOContractFitContext) -> TreePOContractFitResult:
        from src.ctreepo.distillation import DistillationTrainConfig, fit
...
class EmbeddingFNONodeDistillationAdapter(TreePOContractAdapter):
    ...
    def fit(self, context: TreePOContractFitContext) -> TreePOContractFitResult:
        from src.ctreepo.embedding_fno import EmbeddingFNOTrainConfig, fit_embedding_fno_node_regressor
