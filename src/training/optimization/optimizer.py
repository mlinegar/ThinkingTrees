...
from src.training.core import Prediction, UnifiedTrainingExample
from src.training.config import OptimizationConfig
from src.training.metrics import metric as default_metric_factory

# Note: The new registry-based optimizer system is in the optimizers/ submodule.
# To use it, import directly:
#   from src.training.optimization import get_optimizer, OptimizerRegistry
# Or via the training package:
#   from src.training import get_optimizer, OptimizerRegistry
