...
from src.core.semantic_prompting import semantic_document_memory
...
class BatchedDocPipeline:
    ...
    def _ensure_semantic_components(self) -> bool:
        ...
        from src.config.settings import load_settings, get_embedding_model, get_embedding_url
    ...
    def _get_ctreepo_prediction(self, text: str):
        ...
        if hasattr(self, "_unified_ctreepo_model"):
            if self._unified_ctreepo_model is None:
                return None, 0.0
            from src.training.ctreepo_trainer import extract_root_sketch
    ...
    def _build_all_unified_trees(
        ...
        """
        from src.tree.embedding_tree import build_unified_tree
