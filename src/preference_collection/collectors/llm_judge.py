"""
LLM-based preference collector.

Uses an LLM (PairwiseJudge, GenRM, or generic DSPy module) to produce
multi-dimensional preference data. Can produce preference + scores + critique
...
class LLMJudgeCollector:
    """Preference collector using an LLM judge.
    ...
    def collect(
        ...
        **kwargs: Any,
        ...
        """Collect LLM-based preference data.
