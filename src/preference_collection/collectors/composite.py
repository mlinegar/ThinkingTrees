"""
Composite preference collector.

Combines multiple collectors, aggregating their responses into a single
PreferenceResponse. Useful for getting complementary preference data -- e.g.,
...
from src.preference_collection.collector import PreferenceCollector, register_collector
...
class CompositeCollector:
    ...
    Each sub-collector produces a PreferenceResponse. The composite merges them
    ...
    Usage:
        from src.preference_collection import get_collector
    ...
    def collect(
        ...
        **kwargs: Any,
        ...
        """Collect preference data from all sub-collectors and merge responses."""
        responses: Dict[str, PreferenceResponse] = {}
    ...
    def _merge(
        ...
        """Merge multiple PreferenceResponses into one."""
        # Determine which response provides preference
        pref_resp: Optional[PreferenceResponse] = None
    ...
    async def collect_async(
        ...
        **kwargs: Any,
        ...
        async def _run(name: str, collector: Any) -> Tuple[str, Optional[PreferenceResponse]]:
            try:
