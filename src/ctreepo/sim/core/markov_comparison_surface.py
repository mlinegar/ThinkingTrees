...
from src.ctreepo.sim.core.markov_observed_token_policy import (
...
def resolve_markov_comparable_surface(
    *,
    ...
    from src.ctreepo.sim.core.fno_arch_config import resolve_fno_arch_from_mapping
...
def comparable_surface_snapshot_from_mapping(
    ...
    mapping = _mapping_from_config(config)
    from src.ctreepo.sim.core.fno_arch_config import resolve_fno_arch_from_mapping as _resolve_snap
