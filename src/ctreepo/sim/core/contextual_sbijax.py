...
def _hll_config(*, precision: int, hash_bits: int):
    from src.tree.hll import HLLConfig
...
def _hll_register_state_from_tokens_np(
    ...
    *,
    ...
    from src.tree.hll import HyperLogLogSketch
...
def _hll_estimate_from_normalized_registers_np(
    ...
    *,
    ...
    from src.tree.hll import _hll_alpha
...
def load_markov_contextual_splits_from_bundle(
    ...
    *,
    ...
    """Load saved Markov bundles for contextual-sufficiency probes.
    ...
    from src.ctreepo.sim.core.markov_changepoint_ops_count import MarkovOPSDataBundle
