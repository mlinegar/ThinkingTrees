...
from src.ctreepo.sim.suite.simulation_buildout import main as legacy_build_main
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.cmd == "report":
        if not bool(args.skip_plots):
            ...
            if rc != 0:
                return rc
        from src.ctreepo.sim.cli.report.simulation_buildout import main as _report_main
