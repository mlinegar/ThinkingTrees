...
from src.ctreepo.sim.suite.lda_tree_recovery_exact_builder import main as exact_builder_main
from src.ctreepo.sim.suite.lda_tree_recovery_world_batch_builder import main as world_batch_builder_main
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.cmd == "report":
        from src.ctreepo.sim.cli.report.lda_tree_recovery_progress import main as _report_main  # noqa: WPS433
