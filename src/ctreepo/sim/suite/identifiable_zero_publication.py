...
from src.ctreepo.sim.cli.sweep_segment_lda_ops_weight_recovery import _iter_runs as _iter_segment_runs
from src.ctreepo.sim.cli.sweep_segmented_lda_ctreepo import _iter_runs as _iter_ctree_runs
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if ns.cmd == "report":
        ...
        from src.ctreepo.sim.cli.report.identifiable_zero_publication_clean import (  # noqa: WPS433
