...
def build_suite(
    *,
    ...
    # ----------------------------
    from src.ctreepo.sim.cli.sweep_segment_lda_ops_weight_recovery import (  # noqa: WPS433
        main as _seg_sweep,
    )
    ...
    if bool(include_markov):
        from src.ctreepo.sim.cli.sweep_markov_changepoint_ops_count import (  # noqa: WPS433
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if ns.cmd == "report":
        from src.ctreepo.sim.cli.report.identifiable_zero_suite import (  # noqa: WPS433
