...
from src.ctreepo.sim.cli.exec_cmds import main as exec_cmds_main
...
from src.ctreepo.sim.suite.cpu_megasweep import main as legacy_build_main
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.cmd == "report":
        if not bool(args.skip_plots):
            ...
            if int(rc) != 0:
                return int(rc)
        from src.ctreepo.sim.cli.report.cpu_megasweep import main as _main_report
        from src.ctreepo.sim.cli.report.cpu_megasweep_readable import main as _readable_report
