...
from src.ctreepo.ladder import continue_ladder as continue_component_ladder
...
def _ensure_treepo_on_path() -> None:
    ...
    # unrelated outer checkout (e.g. ~/treepo) ahead of the repo's package.
...
def _stage_name_from_prefix(
    ...
    *,
    ...
    from src.ctreepo.alternating import stage_label_for_iteration, stage_name_for_iteration
...
def _iteration_record_dict(
    *,
    ...
    from src.ctreepo.alternating import IterationRecord
