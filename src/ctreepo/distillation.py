...
def fit_f_embedding_proxy(
    ...
    *,
    ...
    if method_key == "ridge":
        from src.training.embedding_proxy import fit_embedding_ridge_proxy
        ...
        from src.training.embedding_proxy import fit_embedding_linear_sgd_proxy
    ...
    *,
    ...
    if route == ((TRAIN_TARGET_G,), STUDENT_MODEL_LM_SFT):
        ...
        if bool(cfg.g_lm.run_trl_sft):
            ...
            from src.training.trl_training import TRLTrainingConfig, train_sft
    ...
    if route == ((TRAIN_TARGET_F,), STUDENT_MODEL_LM_SCALAR_REGRESSION):
        ...
        if bool(cfg.f_lm.run_trl_scalar_reward):
            ...
            from src.training.trl_training import TRLTrainingConfig, train_scalar_reward_records
