...
from src.ctreepo.contracts import CTreePOProgramSpec, MethodDescriptor
...
class SketchAdapterProgram:
    """Runtime wrapper around `treepo.bench.sketches.SketchAdapter`."""
...
def _build_hll_adapter(spec: CTreePOProgramSpec) -> Any:
    _ensure_treepo_on_path()
    from treepo.bench.sketches import make_hll_adapter
