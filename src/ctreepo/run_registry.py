...
from src.ctreepo.contracts import RUN_MANIFEST_SCHEMA_VERSION, TREE_BUNDLE_SCHEMA_VERSION
...
_BASE_TARGETS: tuple[RunTargetRecord, ...] = (
    ...
    RunTargetRecord(
        ...
        # The treepo package moved to the standalone official repo
        # (~/treepo, 2026-06-10); the workspace copy is archived at
        # OLD_treepo/. The venv's editable install points at the official
        # checkout, so the bench runner lives outside this repo now.
        path="/home/mlinegar/treepo/src/treepo/bench/runner.py",
        domain="classical_sketch",
        role="bench_runner",
        backend="treepo",
        status="thin_wrapper",
