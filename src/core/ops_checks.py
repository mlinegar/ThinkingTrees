...
Usage:
    from src.core.ops_checks import CheckType, CheckConfig

    # For human-in-the-loop auditing:
    from src.tree.auditor import Auditor, AuditConfig, ReviewQueue

    # For training data generation:
    from src.tree.verification import TreeVerifier
"""
