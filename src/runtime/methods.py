...
from src.runtime.answering import answer_multi_choice
...
from src.runtime.trace import StepEvent
...
from treepo.llm import EmbeddingClient, HashingEmbeddingClient  # noqa: E402,F401
...
class _BackboneTreeOperator:
    ...
    def capability_report(self) -> Any:
        from src.core.ops_checks import EvidenceStatus, OperatorCapabilityReport
