...
### Fixed
- Fixed GenRM batch client not being properly closed after tree building, eliminating broken pipe errors
- Changed default dataset from `jsonl` to `manifesto` in settings.yaml for better out-of-box experience
