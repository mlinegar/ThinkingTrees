...
Usage:
    python scripts/report_law_stress.py --family markov --input-root outputs/...
    python scripts/report_law_stress.py --family lda    --input-root outputs/...
...
from src.ctreepo.sim.report.aggregation import (
