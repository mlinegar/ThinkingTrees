...
def _scalar_model_predictions(
    *,
    ...
    from src.training.trl_training import _concat_prompt_response  # type: ignore
...
def _embedding_model_predictions(
    *,
    ...
    from src.training.embedding_proxy import VLLMEmbeddingClient, load_embedding_proxy_model
