...
from src.ctreepo.sim.core.boundary_topic_treepo_preference import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Run exact boundary-topic TreePO utility simulation.")
    p.add_argument("--oracle-profile", type=str, default="topic_plus_boundary")
    ...
    p.add_argument("--n-topics", type=int, default=3)
    p.add_argument("--n-leaves", type=int, default=6)
...
def main() -> int:
    ...
    summary = run_boundary_topic_exact_utility_experiment(cfg)
