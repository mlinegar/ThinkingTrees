#!/usr/bin/env python3
"""CPU-only walkthrough: submit human feedback and export canonical supervision."""
...
from src.feedback import FeedbackDimension, FeedbackRequest, FeedbackStore
...
def run_example() -> dict[str, object]:
    ...
    store.submit_human_pairwise_feedback(
        "pair_req",
        preferred="B",
    ...
    store.submit_human_scalar_feedback(
        "scalar_req",
        score=4.0,
    ...
    return {
        "example": "human_feedback_store_export",
