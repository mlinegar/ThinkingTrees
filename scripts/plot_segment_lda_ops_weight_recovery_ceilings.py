...
This script is meant to make the "upper bounds" explicit:
...
def main() -> int:
    ...
    # Group by x values for aggregation (use exact float keys from sim; sweeps are discrete).
    ...
    # Panel A: root MAE vs x for ridge variants + baselines.
    ...
    for key, label, color, ls in curves:
        ...
        # Only band the main pipeline curve to avoid clutter.
    ...
    # Panel B: gap-to-ceiling vs x (requires ridge_true_topics).
