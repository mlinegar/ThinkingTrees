...
from src.ctreepo.sim.core.markov_treepo_preference import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Run exact Markov TreePO utility simulation.")
    p.add_argument("--oracle-profile", type=str, default="markov_count_endpoints")
...
def main() -> int:
    ...
    summary = run_markov_exact_utility_experiment(cfg)
